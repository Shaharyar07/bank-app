            ...
            <form action="/fundTransfer" method="POST">
              ...
              <div class="py-4 px-8">
                ...
                <div class="mb-4">
                  ...
                  <input class=" border rounded w-full py-2 px-3 text-grey-darker" type="text" name="accountNumber" id="accountNumber"
                     value="{{old('accountNumber')}}" placeholder="Enter Your Account Number">
                ...
                <div class="mb-4">
                  ...
                  <input class=" border rounded w-full py-2 px-3 text-grey-darker" type="number" name="amount"
                    id="amount" value="{{old('Amount')}}" placeholder="Enter the Amount ">
                  <p id=error_creater_id>
                    @error('amount')
                    <span class="text-red-500">{{ $message }}</span>
                    @enderror
