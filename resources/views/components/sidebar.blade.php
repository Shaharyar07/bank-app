<aside
    ...
    <div>
      ...
      <div class="mt-8 text-center">
        ...
        <h5 class="hidden mt-4 text-xl font-semibold text-gray-600 lg:block">Account Holder</h5>
        <span class="hidden text-gray-400 lg:block">0177002000004468</span>
      </div>

      <ul class="space-y-2 tracking-wide mt-8">
        <li>
          <a href='/dashboard' aria-label="dashboard"
            class="px-4 py-3 pointer-cursor flex items-center space-x-4 rounded-xl text-grey-600 group hover:bg-gradient-to-r from-sky-600 to-cyan-400 hover:text-white">
        ...
        <li>
          <a
          href='/transactions'  
          class="px-4 py-3 flex items-center space-x-4 pointer-cursor rounded-xl text-grey-600 group hover:bg-gradient-to-r from-sky-600 to-cyan-400 hover:text-white">
            ...
            <span class="-mr-1 font-medium" >Transactions</span>
          </a>
        </li>
        <li>
          <a
            href='/investments'
            class="px-4 py-3 flex pointer-cursor items-center space-x-4 rounded-xl text-grey-600 group hover:bg-gradient-to-r from-sky-600 to-cyan-400 hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="-mr-1 font-medium">Investments</span>
          </a>
        </li>
        ...
        <li>
          <a
            ...
            <span class="-mr-1 font-medium" >Transfer Funds</span>
          </a>
        </li>
      </ul>
    </div>
